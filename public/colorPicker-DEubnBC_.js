import{di as b,d2 as $,dS as u,h5 as m,dh as w,co as C,h6 as E,ey as B,bw as d}from"./index-BwIBo_Hm.js";import{b as S}from"./appDialogsManager-Cy5bHA_2.js";const f=380,A=198,I=f/A,L=f,x=24,r=class r{constructor({buildLayout:t=r.defaultBuildLayout,pickerBoxWidth:e=f,pickerBoxHeight:s=A,sliderWidth:n=L,thickSlider:l=!1}={}){this.hue=0,this.saturation=100,this.lightness=50,this.alpha=1,this.elements={},this.onGrabStart=()=>{document.documentElement.style.cursor=this.elements.boxDragger.style.cursor="grabbing"},this.onGrabEnd=()=>{document.documentElement.style.cursor=this.elements.boxDragger.style.cursor=""};const i=r.idSeed++,a=b(`
      <svg class="${r.BASE_CLASS+"-box"}" viewBox="0 0 ${e} ${s}" style="width: ${e}px; height: ${s}px;">
        <defs>
        ...
        <svg class="${r.BASE_CLASS+"-dragger"} ${r.BASE_CLASS+"-box-dragger"}" x="0" y="0">
          <circle r="11" fill="inherit" stroke="#fff" stroke-width="2"></circle>
        </svg>
      </svg>
    `),c=b(`
      <div class="${r.BASE_CLASS+"-sliders"}" style="width: ${n}px; height: ${x}px">
        <svg class="${r.BASE_CLASS+"-color-slider"}" viewBox="0 0 ${n} ${x}">
          <defs>
