...
describe('getRowIconBackgroundColor', () => {
  ...
  test('uses the colors assigned in the Figma Settings section', () => {
    expect(ROW_ICON_COLOR_BY_NAME.auto_delete_filled).toBe('grey');
    expect(ROW_ICON_COLOR_BY_NAME.birthday_filled).toBe('purple');
    expect(ROW_ICON_COLOR_BY_NAME.bubble_filled).toBe('pink');
    ...
    expect(ROW_ICON_COLOR_BY_NAME.emoji_filled).toBe('orange');
    expect(ROW_ICON_COLOR_BY_NAME.faceid_filled).toBe('green');
    expect(ROW_ICON_COLOR_BY_NAME.general_filled).toBe('grey');
    expect(ROW_ICON_COLOR_BY_NAME.info_filled).toBe('grey');
    ...
    expect(ROW_ICON_COLOR_BY_NAME.lock_filled).toBe('red');
    expect(ROW_ICON_COLOR_BY_NAME.location_filled).toBe('green');
    expect(ROW_ICON_COLOR_BY_NAME.message_filled).toBe('green');
    expect(ROW_ICON_COLOR_BY_NAME.mention_filled).toBe('blue');
    expect(ROW_ICON_COLOR_BY_NAME.person_crossed_filled).toBe('grey');
    expect(ROW_ICON_COLOR_BY_NAME.policy_filled).toBe('green');
    expect(ROW_ICON_COLOR_BY_NAME.premium_lock_filled).toBe('grey');
    expect(ROW_ICON_COLOR_BY_NAME.recent_actions_filled).toBe('green');
    expect(ROW_ICON_COLOR_BY_NAME.speaker_filled).toBe('green');
    expect(ROW_ICON_COLOR_BY_NAME.sputnik_filled).toBe('purple');
    expect(ROW_ICON_COLOR_BY_NAME.sticker_filled).toBe('purple');
    expect(ROW_ICON_COLOR_BY_NAME.time_filled).toBe('pink');
