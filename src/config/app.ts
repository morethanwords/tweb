...
// Peers (by peerId) hidden from the dialog lists for everyone except CRM
// superadmins (gated at the filter sites via appCrmManager / @stores/crmRole).
// User peerId === userId, so 777000 is the official "Telegram" service-notifications
// chat — it receives the shared support account's login codes.
