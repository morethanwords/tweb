...
export type ChannelsGetFutureCreatorAfterLeave = {
  channel: InputChannel
};
...
export interface MethodDeclMap {
  ...
  'channels.getFutureCreatorAfterLeave': {req: ChannelsGetFutureCreatorAfterLeave, res: User},
}
