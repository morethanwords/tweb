const lang = {
  ...
  'StarGiftWearBenefit1Text': 'The glittering icon of this item will be displayed next to your name.',
  'StarGiftWearBenefit2Title': 'Unique Profile Design',
  'StarGiftWearBenefit2Text': 'Your profile page will get the color and the symbol of this item.',
  'StarGiftWearBenefit3Title': 'Proof of Ownership',
  'StarGiftWearBenefit3Text': 'Tapping the icon of this item next to your name will show its info and owner.',
  ...
  // Admin log messages with admin name parameter (%s)
  'AdminLog.ChangeTitleChannel': '%s changed the channel title',
  'AdminLog.ChangeTitleGroup': '%s changed the group title',
  'AdminLog.ChangeAboutChannel': '%s changed the channel about',
  'AdminLog.ChangeAboutGroup': '%s changed the group about',
  ...
  'AdminLog.ParticipantBanned': '%s was banned',
  'AdminLog.ParticipantPermissionsToggled': '%s had permissions changed',
  'AdminLog.AdminPromoted': '%s was promoted to admin',
  'AdminLog.AdminDemoted': '%s was demoted from admin',
  ...
  'AdminLog.DefaultBannedRightsChanged': '%s changed default permissions',
  ...
  'AdminLog.ParticipantMuted': '%s was muted',
  'AdminLog.ParticipantUnmuted': '%s was unmuted',
  'AdminLog.ToggleGroupCallSettingEnabled': '%s enabled join muted',
  'AdminLog.ToggleGroupCallSettingDisabled': '%s disabled join muted',
  ...
  'AdminLog.ParticipantVolumeChanged': '%s had volume changed',
  ...
  'AdminLog.ParticipantJoinedByRequest': '%s joined by request',
  ...
  'AdminLog.ChangeProfilePeerColor': '%s changed the profile accent color',
  'AdminLog.ChangeWallpaper': '%s changed the wallpaper',
  'AdminLog.ChangeEmojiStatus': '%s changed the emoji status',
  'AdminLog.ChangeEmojiStickerSet': '%s changed the emoji sticker set',
