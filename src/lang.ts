...
const lang = {
  ...
  'Stars.TOS': `By proceeding and purchasing Stars, you agree with the [Terms and Conditions](https://${shortDomain}.org/tos).`,
  ...
  'Chat.Message.Sponsored.Link': `https://ads.${appName}`,
