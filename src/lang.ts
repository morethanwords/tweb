const lang = {
  ...
  'VoiceChat.RTMP.Info': 'To stream video with another app, enter these Server URL and Stream Key in your streaming app.',
  'VoiceChat.RTMP.Desc': 'Software encoding recommended (x264 in OBS).',
  'VoiceChat.RTMP.ServerURL': 'server URL',
  'VoiceChat.RTMP.StreamKey': 'stream key',
  'VoiceChat.RTMP.Revoke': 'Revoke Stream Key',
  'VoiceChat.RTMP.Settings': 'Stream Settings',
  'CreateExternalStream.StartStreamingInfo': 'Once you start broadcasting in your streaming app, tap Start Streaming below.',
  ...
  'VoiceChat.RTMP.Record.Stream.Title': 'Recording Title',
  'VoiceChat.RTMP.Record.Stream': 'Record this stream and save the result into an file?',
  'VoiceChat.RTMP.Record.Stream.Participants.Info': 'Participants will see that the chat is being recorded.',
  'VoiceChat.RTMP.Record.Stream.Also.Video': 'Also Record Video',
  'VoiceChat.RTMP.Record.Stream.Audio': 'This chat will be recorded into an audio file',
  'VoiceChat.RTMP.Record.Stream.Choose.Orientation': 'Choose video orientation',
  ...
  'PeerInfo.Action.RTMPStream': 'RTMP Stream',
