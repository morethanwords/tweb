const lang = {
  ...
  'MultiAccount.AllAccounts': 'Notifications from all accounts',
  ...
  'StarGiftValueAboutAverage': 'This is the average sale price of **%s** gifts on Telegram and Fragment over the past month.',
  ...
  'SuggestedPosts.AgreementReached.WillBeRefunded': '%s If %s removes the post before the **%d** hours pass, the payment will be refunded',
