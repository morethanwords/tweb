const lang = {
  ...
  'AgentMetrics.Title': 'Agent Performance',
  'AgentMetrics.TodayOverview': 'Today',
  'AgentMetrics.WeekOverview': 'Last 7 days',
  'AgentMetrics.VsWeekAvg': 'Today vs daily average',
  'AgentMetrics.VsWeekAvg.Caption': 'Compared to your average day over the last 7 days.',
  'AgentMetrics.MessagesSent': 'Messages sent',
  'AgentMetrics.MessagesReceived': 'Messages received',
  'AgentMetrics.Conversations': 'Conversations',
  'AgentMetrics.AvgResponse': 'Avg. response time',
  'AgentMetrics.MedianResponse': 'Median response time',
  'AgentMetrics.FirstResponse': 'First response time',
  'AgentMetrics.ActiveTime': 'Active time',
  'AgentMetrics.QueueHealth': 'Queue health',
  'AgentMetrics.TotalUnread': 'Total unread',
  'AgentMetrics.Unanswered': 'Awaiting reply',
  'AgentMetrics.SlaBreaches': 'SLA breaches (5 min)',
  'AgentMetrics.OldestUnanswered': 'Oldest unanswered',
  'AgentMetrics.ActivityTimeline': 'Activity timeline',
  'AgentMetrics.NoActivity': 'No activity recorded yet.',
  'AgentMetrics.NoChange': 'No change',
  'AgentMetrics.MegagroupLeaderboard': 'Team group leaderboard',
  'AgentMetrics.MegagroupLeaderboard.Caption': 'Message volume in an internal megagroup (Telegram stats).',
  'AgentMetrics.PickMegagroup': 'Choose megagroup',
  'AgentMetrics.Messages': 'messages',
  'AgentMetrics.AvgChars': 'avg chars',
  'AgentMetrics.ExportCsv': 'Export CSV for HR',
  'AgentMetrics.Activity.message_sent': 'Sent message',
  'AgentMetrics.Activity.message_received': 'Received message',
  'AgentMetrics.Activity.active': 'Active',
  'AgentMetrics.Activity.idle': 'Idle',
  'AgentMetrics.IdentitySection': 'This session',
  'AgentMetrics.IdentityCaption': 'Label the messages YOU send from this browser session with your agent name. The label is shown only here — it is never added to the message or seen by anyone else. Useful when several agents share this account from different sessions.',
  'AgentMetrics.AgentName': 'Your agent name',
  'QuickReplies.Title': 'Quick Replies',
  'QuickReplies.Caption': 'Prepare answers to frequently asked questions and insert them into the message field with one tap.',
  'QuickReplies.Add': 'Add quick reply',
  'QuickReplies.AddTitle': 'New quick reply',
  'QuickReplies.EditTitle': 'Edit quick reply',
  'QuickReplies.TitleLabel': 'Title (e.g. the question)',
  'QuickReplies.TextLabel': 'Answer',
  'QuickReplies.EmptyHint': 'No quick replies yet.\nAdd one to reuse it when answering.',
  'QuickReplies.EmptyError': 'Please fill in both the title and the answer.',
  'QuickReplies.LimitError': 'You have reached the maximum number of quick replies.',
  'QuickReplies.DeleteTitle': 'Delete quick reply',
  'QuickReplies.DeleteConfirm': 'Are you sure you want to delete "%1$s"?',
  'QuickReplies.AttachMenu': 'Quick reply',
  'QuickReplies.PickerTitle': 'Choose a quick reply',
  'QuickReplies.NoMatches': 'No quick replies match your search.',
  'QuickReplies.SourceCrm': 'CRM',
  'Crm.Title': 'Andropay CRM',
  'Crm.Caption': 'Connect this session to your Andropay CRM to pull shared FAQ/templates into quick replies and look up customers. Sign in with your agent mobile and OTP — the token is stored only in this browser.',
  'Crm.BaseUrl': 'CRM address (e.g. https://andropay.xyz)',
  'Crm.Mobile': 'Agent mobile (exact, e.g. 00989012345678)',
  'Crm.Code': 'OTP code',
  'Crm.SendCode': 'Send code',
  'Crm.Connect': 'Connect',
  'Crm.Disconnect': 'Disconnect',
  'Crm.ConnectedAs': 'Connected as',
  ...
  'Crm.Ticket.Close': 'Close',
  'Crm.Ticket.Reopen': 'Reopen',
  'Crm.Ticket.Opened': 'Ticket #%1$d opened',
  'Crm.Ticket.Closed': 'Ticket #%1$d closed',
  'Crm.Ticket.Reopened': 'Ticket #%1$d reopened',
  'Crm.Ticket.NoOpen': 'No open ticket to close',
  'Crm.Ticket.CloseFailed': 'Failed to close the ticket, please try again',
  'Crm.Ticket.CloseForbidden': 'You don\'t have access to close this ticket',
