const lang = {
  ...
  'Chat.Search.PreviousResult': 'Previous search result',
  'Chat.Search.NextResult': 'Next search result',
  'Chat.GoToLatestMessage': 'Go to latest message',
  'Chat.GoToNextMention': 'Go to next mention',
  'Chat.GoToNextReaction': 'Go to next reaction',
  'Chat.GoToNextPollVote': 'Go to next poll vote',
  ...
  'Link.NotSupported': 'This link is not supported on Telegram Web.',
  ...
  'MediaEditor.Tabs': 'Editing tools',
  'MediaEditor.Tab.Adjustments': 'Adjustments',
  'MediaEditor.Tab.Crop': 'Crop',
  'MediaEditor.Tab.Text': 'Text',
  'MediaEditor.Tab.Draw': 'Draw',
  'MediaEditor.Tab.Stickers': 'Stickers',
  'MediaEditor.RotateLeft': 'Rotate left',
  'MediaEditor.FlipHorizontal': 'Flip horizontally',
  'MediaEditor.VideoPosition': 'Video position',
  'MediaEditor.VideoCropStart': 'Trim start',
  'MediaEditor.VideoCropEnd': 'Trim end',
  'MediaEditor.VideoCoverFrame': 'Cover frame',
  'MediaEditor.AddTextLayer': 'Add text layer',
  'MediaEditor.DeselectLayer': 'Deselect current layer',
  'MediaEditor.SelectStickerLayer': 'Select sticker layer',
  'MediaEditor.AspectRatio': 'Aspect ratio',
  'MediaEditor.Size': 'Size',
  'MediaEditor.Font': 'Font',
  'MediaEditor.TextAlignment': 'Text alignment',
  'MediaEditor.AlignLeft': 'Align left',
  'MediaEditor.AlignCenter': 'Align center',
  'MediaEditor.AlignRight': 'Align right',
  'MediaEditor.TextStyle': 'Text style',
  'MediaEditor.TextStyle.Normal': 'Normal text',
  'MediaEditor.TextStyle.Outline': 'Outlined text',
  'MediaEditor.TextStyle.Background': 'Text with background',
  ...
  'MediaEditor.StickerSets': 'Sticker sets',
  ...
  'Stars.Transaction.Ads': 'Telegram Ads',
  'Stars.Transaction.API': 'Telegram API',
  ...
  'Stars.Transaction.Premium': 'Telegram Premium · %d months',
  ...
  'Stars.Transaction.GramTOS': 'Review the **[Terms of Service](https://telegram.org/tos)** for Grams.',
  ...
  'Call.Close': 'Close',
  'Call.Screen': 'Screen',
  'Call.Fullscreen.Enter': 'Enter full screen',
  ...
  'CallLink.About': 'Anyone on Telegram can join your call by following the link below.',
  ...
  'GeneralSettings.IncreaseContrast': 'Increase Contrast',
  'GeneralSettings.IncreaseContrastInfo': 'Make text and buttons easier to see.',
  'GeneralSettings.IncreaseContrast.SearchKeywords': 'accessibility, a11y, high contrast, readability, colors',
  ...
  'AccDescr.ResumeRecording': 'Resume recording',
  'AccDescr.SkipToConversation': 'Skip to conversation',
  'AccDescr.LoginCode': 'Login code',
  'AccDescr.EmailCode': 'Email code',
  'AccDescr.ChatList': 'Chat list',
  'AccDescr.MessageHistory': 'Message history',
  'AccDescr.ChatInfo': 'Chat info',
  'AccDescr.Back': 'Back',
  'AccDescr.Hours': 'Hours',
  'AccDescr.Minutes': 'Minutes',
  'AccDescr.PreviousMonth': 'Previous month',
  'AccDescr.NextMonth': 'Next month',
  'AccDescr.ChatPreview': 'Chat preview',
  'AccDescr.LocationAccess': 'Location access',
  'AccDescr.StickerNumber': 'Sticker %s',
  'AccDescr.GifNumber': 'GIF %s',
  'AccDescr.Volume': 'Volume',
  'AccDescr.PlaybackPosition': 'Playback position',
  'AccDescr.OpenMedia': 'Open media',
  'AccDescr.MediaActions': 'Media actions',
  'AccDescr.EditAvatar': 'Edit avatar',
  'AccDescr.StoryCaption': 'Story caption',
  'AccDescr.CopyStreamURL': 'Copy stream URL',
  'AccDescr.CopyStreamKey': 'Copy stream key',
  'AccDescr.ShowStreamKey': 'Show stream key',
  'AccDescr.OpenContact': 'Open contact %s',
  'AccDescr.CopyContactPhone': 'Copy phone number for %s',
  'AccDescr.LogEntryDetails': 'Event details',
  'AccDescr.TranscribeAudio': 'Transcribe audio',
  'AccDescr.ToggleTranscription': 'Show transcription',
  'AccDescr.OpenDocument': 'Open file %s',
  'AccDescr.PlaybackSpeed': 'Playback speed',
  'MediaEditor.LayerActions': 'Layer actions',
  'MediaEditor.MoveUp': 'Move up',
  'MediaEditor.MoveDown': 'Move down',
  'MediaEditor.MoveLeft': 'Move left',
  'MediaEditor.MoveRight': 'Move right',
  'MediaEditor.EnlargeLayer': 'Enlarge layer',
  'MediaEditor.ShrinkLayer': 'Shrink layer',
  'MediaEditor.RotateLayer': 'Rotate layer',
  'MediaEditor.FineRotation': 'Fine rotation',
  'MediaEditor.CustomColor': 'Custom color',
  'AccDescr.Stickers': 'Stickers',
  'AccDescr.Gifs': 'GIFs',
  'AccDescr.DeleteLastCharacter': 'Delete last character',
  'AccDescr.ChangeTopicColor': 'Change topic color',
  'AccDescr.MicrophoneLevel': 'Microphone level',
  'AccDescr.RevealMedia': 'Reveal hidden media',
  'VoiceChat.Participants.Show': 'Show participants',
  'VoiceChat.Participants.Hide': 'Hide participants',
  'VoiceChat.RaiseHand': 'Raise hand',
  'VoiceChat.HandRaised': 'Hand raised',
