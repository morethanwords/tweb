const lang = {
  ...
  'ConnectionSettings.Title': 'Connection',
  'ConnectionSettings.Type': 'Connection type',
  'ConnectionSettings.TypeWebSocket': 'WebSocket (default)',
  'ConnectionSettings.TypeTCP': 'TCP (direct)',
  'ConnectionSettings.TypeSocks5': 'SOCKS5 proxy',
  'ConnectionSettings.TypeMtproxy': 'MTProto proxy',
  'ConnectionSettings.Hint': 'TCP and proxy connections are routed over a raw obfuscated socket, like the desktop app. Changes apply immediately.',
  'ConnectionSettings.Saved': 'Connection settings applied',
  'ConnectionSettings.Invalid': 'Please fill in the proxy server and port',
  'Story': 'Story',
  'Stories': 'Stories',
  'StoriesCount': {
    'one_value': '%1$d story',
  ...
  'Call.Confirm.Discard.Conference.Header': 'Conference Call in Progress',
  'Call.Confirm.Discard.Conference.ToVoice.Text': 'Leave the conference call and start a video chat in "%2$@"?',
  'Call.Confirm.Discard.Conference.ToCall.Text': 'Leave the conference call and start a call with "%2$@"?',
  'Call.Confirm.Discard.Conference.ToLive.Text': 'Leave the conference call and start a live stream in "%2$@"?',
  'Call.Confirm.Discard.Conference.ToConference.Text': 'Leave the current conference call and join a new one?',
  'Call.Confirm.Discard.Voice.ToConference.Text': 'Leave video chat in "%1$@" and join a conference call?',
  'Call.Confirm.Discard.Call.ToConference.Text': 'End call with "%1$@" and join a conference call?',
  'Call.Confirm.Discard.Live.ToConference.Text': 'Leave live stream in "%1$@" and join a conference call?',
