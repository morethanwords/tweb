const lang = {
  ...
  'SuggestedPosts.AgreementReached.WillReceive': '%s %s will receive the **Stars** once the post has been live for **24** hours',
  'SuggestedPosts.AgreementReached.WillBeRefunded': '%s If %s removes the post before the **24** hours pass, the payment will be refunded',
