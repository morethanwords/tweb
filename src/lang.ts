...
const lang = {
  ...
  'ChatAutomation.BotDescription': `Enter the username or URL of the ${appName} bot that you want to automatically process your chats.`,
  ...
  'EditBot.Buttons.Caption': `Use [@BotFather](https://${shortDomain}/botfather) to manage this bot.`,
  ...
  'ChatList.Main.EmptyPlaceholder.Subtitle': `You have %s on ${appName}`,
  'ChatList.Main.EmptyPlaceholder.SubtitleNoContacts': `Use ${appName} app on your [Android](https://${shortDomain}/android) or [iOS](https://${shortDomain}/dl/ios) device to sync your contacts`,
  ...
  'ClientPip.PlaceholderTitle': `${appName} is in Picture-in-Picture`,
  ...
  'Deactivated.Subtitle': `${appName} supports only one active tab with the app.\nClick anywhere to continue using this tab.`,
  'Deactivated.Version.Title': 'WebK has updated...',
  'Deactivated.Version.Subtitle': `Another tab is running a newer version of ${appName}.\nClick anywhere to reload this tab.`,
  ...
  'Notifications.Default': `Give ${appName} permission to send notifications. You may need to refresh the page to see the changes.`,
  ...
  'UnconfirmedAuthDeniedWarning': `Never send your login code to anyone or you can lose your ${appName} account!`,
  ...
  'Message.Unsupported.Desktop': `__This message is currently not supported on ${appName} Web.__`,
  'Message.Unsupported.Mobile': `__This message is currently not supported on ${appName} Web.__`,
  ...
  'PushNotification.Message.Refreshing': `${appName} is syncing in the background...`,
  'LogOut.Description': `Are you sure you want to log out?\n\nNote that you can seamlessly use ${appName} on all your devices at once.`,
  // "PushNotification.Action.Mute1d.Success": "Notification settings were successfully saved.",
  // it is from iOS
  ...
  'Video.Unsupported.Desktop': `__Unfortunately, this video can\'t be played on ${appName} Web.__`,
  'Video.Unsupported.Mobile': `__Unfortunately, this video can\'t be played on ${appName} Web.__`,
  ...
  'BoostsViaGifts.EndSubtitle': {
    'one_value': `Choose when %d subscriber of your channel will receive ${appName} Premium.`,
    'other_value': `Choose when %d subscribers of your channel will be randomly selected to receive ${appName} Premium.`
  },
  ...
  'BoostsViaGifts.DurationSubtitle': `You can review the list of features and terms of use for ${appName} Premium [here]().`,
  ...
  'Giveaway.Info': `On **%s**, ${appName} will automatically select %s **%s**.`,
  'Giveaway.Info.End': `On **%s**, ${appName} automatically selected %s **%s**.`,
  'Giveaway.Info.Date': `On **%s**, ${appName} will automatically select %s **%s** after **%s**.`,
  'Giveaway.Info.Date.End': `On **%s**, ${appName} automatically selected %s **%s** after **%s**.`,
  'Giveaway.Info.Several': `On **%s**, ${appName} will automatically select %s **%s** and %s.`,
  'Giveaway.Info.Several.End': `On **%s**, ${appName} automatically selected %s **%s** and %s.`,
  'Giveaway.Info.Several.Date': `On **%s**, ${appName} will automatically select %s **%s** and %s after **%s**.`,
  'Giveaway.Info.Several.Date.End': `On **%s**, ${appName} automatically selected %s **%s** and %s after **%s**.`,
  ...
  'Multiplier': '%s x %s',
  'Giveaway.Results': {
    'one_value': `%d winner of the giveaway was randomly selected by ${appName} and received private message with giftcode.`,
    'other_value': `%d winners of the giveaway were randomly selected by ${appName} and received private messages with giftcodes.`
  },
  ...
  'Giveaway.Results.NoWinners': {
    'one_value': `Due to the giveaway terms, no winner could be selected by ${appName}, **1** gift link was forwarded to channel administrators.`,
    'other_value': `Due to the giveaway terms, no winners could be selected by ${appName}, all **%d** gift links were forwarded to channel administrators.`
  },
  'Giveaway.Results.NoWinners.Stars': `Due to the giveaway terms, no winners could be selected by ${appName}, all stars were credited to channel administrators.`,
  ...
  'BoostsViaGifts.AdditionalPrizesSubtitleOff': `Turn this on if you want to give the winners your own prizes in addition to ${appName} Premium subscriptions.`,
  'BoostsViaGifts.AdditionalPrizesDetailed': {
    'one_value': `**%d** ${appName} Premium subscription for %s`,
    'other_value': `**%d** ${appName} Premium subscriptions for %s`
  },
  'BoostsViaGifts.AdditionalPrizesDetailedWith': {
    'one_value': `**%d** %s with ${appName} Premium subscription for %s`,
    'other_value': `**%d** %s with ${appName} Premium subscriptions for %s`
  },
  ...
  'Giveaway.With': 'with',
  'Giveaway.WithSubscriptionsSingle': `${appName} Premium subscription for %s`,
  'Giveaway.WithSubscriptionsPlural': `${appName} Premium subscriptions for %s`,
  'Giveaway.WithStars': {
  ...
  'Giveaway.Results.Subtitle': {
    'one_value': `%1$d winner of the **[Giveaway]()** was randomly selected by ${appName}.`,
    'other_value': `%1$d winners of the **[Giveaway]()** were randomly selected by ${appName}.`
  },
  ...
  'GiftCode.ShareReceived': `This link allows you or **[anyone you choose]()** to activate a **${appName} Premium** subscription.`,
  'GiftModal.Title.You': `You gifted **%1$s** a %2$s subscription to ${appName} Premium.`,
  ...
  'SimilarChannels.Unlock': {
    'one_value': `Subscribe to **[${appName} Premium]()** to unlock up to **%d** similar channel.`,
    'other_value': `Subscribe to **[${appName} Premium]()** to unlock up to **%d** similar channels.`
  },
  ...
  'Boost.Reassign.Wait': `Wait until the boost is available or get %s by gifting a **[${appName} Premium]()** subscription.`,
  ...
  'Privacy.VoiceMessagesPremiumCaption': `Subscribe to ${appName} Premium to restrict who can send you voice or video messages.\n\n**[What is ${appName} Premium?]()**`,
  ...
  'Privacy.GiftsPremiumError': `Subscribe to [${appName} Premium]() to restrict who can send you gifts.`,
  ...
  'PrivacySettings.Messages.PremiumError': `Only subscribers of [${appName} Premium]() can restrict receiving messages.`,
  ...
  'OnlyPremiumCanMessage': `**%s** only accepts messages from contacts and **[${appName} Premium]()** subscribers.`,
  ...
  'Rtmp.MediaViewer.Failed.Description': `${appName} doesn\'t see any stream coming from your streaming app. Please make sure you entered the right Server URL and Stream Key in your app.`,
  ...
  'Ads.Reported': `We will review this ad to ensure it matches our **[Ad Policies and Guidelines](https://ads.${shortDomain}/guidelines)**.`,
  'RevenueSharingAdsInfo4SubtitleLearnMore1': `**[Learn More >](https://ads.${shortDomain}/)**`,
  'Stars.TOS': `By proceeding and purchasing Stars, you agree with the [Terms and Conditions](https://${shortDomain}/tos).`,
  'ShowMoreOptions': 'Show More Options',
  'Stars.ConfirmPurchaseButton': 'Confirm and Pay %d',
  'Stars.TransactionTOS': `Review the **[Terms of Service](https://${shortDomain}/tos)** for Stars.`,
  ...
  'InviteLink.Subscription.Caption': `Charge a subscription fee from people joining your channel via this link. [Learn More >](https://${shortDomain}/)`,
  ...
  'Stars.Subscribe.Terms': `By subscribing you agree to the [Terms of Service](https://${shortDomain}).`,
  ...
  'MultiAccount.AccountsLimitDescription': `You have reached the limit of **3** connected accounts. You can add more by subscribing to **${appName} Premium**.`,
  ...
  'InviteViaLink.Premium.Subscribe': `Subscribe to ${appName} Premium`,
  ...
  'Frozen.Violation.Subtitle': `Your account was frozen for breaking ${appName}’s Terms of Service.`,
  ...
  'Verified.Bot': `This bot is verified as official by the representatives of ${appName}.`,
  'Verified.Channel': `This channel was verified by ${appName}.`,
  'Verified.Group': `This group was verified by ${appName}.`,
  'ProfileUnofficialSecurityRisk': `%1$s uses an unofficial ${appName} client — messages to this user may be less secure.`,
  // 'SavedMessages.Count': {
  ...
  'Summary.Limited.Text': `Subscribe to [${appName} Premium]() to increase summary limits.`,
  ...
  'PublicLinksLimitSubtitle': `Reserve up to %d ${shortDomain}/username links`,
  ...
  'TelegramPremiumSubscribedSubtitle': `Thank you for subscribing to **${appName} Premium**.\nHere’s what is now unlocked.`,
  'TelegramPremiumPeerTitle': `%s is a subscriber of **${appName} Premium**`,
  'TelegramPremiumPeerSubtitle': `Owners of **${appName} Premium** accounts have exclusive access to multiple additional features.`,
  ...
  'TelegramPremiumPeerSubtitleEmojiStatus': `Emoji statuses are a premium feature. Other features included in **${appName} Premium**:`,
  ...
  'ContactJoined': `Contact joined ${appName}`,
  'Loading': 'Loading...',
  'Unblock': 'Unblock',
  ...
  'PrivacyPhoneInfo': `Users who have your number saved in their contacts will also see it on ${appName}.`,
  'PrivacyPhoneInfo3': `Users who add your number to their contacts will see it on ${appName} only if they are your contacts.`,
  ...
  'UsernameHelp': `You can choose a username on **${appName}**. If you do, people will be able to find you by this username and contact you without needing your phone number.\n\nYou can use **a–z**, **0–9** and underscores. Minimum length is **5** characters.`,
  'Phone': 'Phone',
  ...
  'YourEmailSkipWarningText': `No, seriously.\n\nIf you forget your password, you will lose access to your ${appName} account. There will be no way to restore it.`,
  ...
  'TelegramFeatures': `${appName} Features`,
  ...
  'NoUsernameFound': `There is no ${appName} account with this username.`,
  ...
  'GroupDescription3': `Public links such as ${shortDomain}/title`,
  ...
  'ReportSentInfo': `${appName} moderators will review your report.\nThank you for your cooperation!`,
  ...
  'SessionsListInfo': `The official ${appName} app is available for Android, iPhone, iPad, Windows, macOS and Linux.`,
  'SponsoredMessage': 'ad',
  ...
  'TelegramFeaturesUrl': `https://${shortDomain}/TelegramTips`,
  'ScamMessage': 'SCAM',
  'FakeMessage': 'FAKE',
  ...
  'PaymentCardSavePaymentInformationInfoLine1': `You can save your payment info for future use. It will be stored directly with the payment provider. ${appName} has no access to your credit card data.`,
  'Done': 'Done',
  ...
  'PrivacyPaymentsClearInfo': `You can delete your shipping info and instruct all payment providers to remove your saved credit cards. Note that ${appName} never stores your credit card data.`,
  ...
  'LimitReachedPinDialogs': `You can\'t pin more than %1$d chats to the top. Unpin some that are currently pinned – or subscribe to **${appName} Premium** to double the limit to **%2$d** chats.`,
  ...
  'LimitReachedCommunities': `You are a member of **%1$d** groups and channels. Please leave some before joining a new one — or subscribe to **${appName} Premium** to double the limit to **%2$d** groups and channels.`,
  ...
  'WebSessionsTitle': `Logged In with ${appName}`,
  'TerminateWebSessionText': 'Are you sure you want to disconnect %1$s?',
  'Disconnect': 'Disconnect',
  'TerminateAllWebSessions': 'Disconnect All Websites',
  'AreYouSureWebSessions': `Are you sure you want to disconnect all websites where you logged in with ${appName}?`,
  'ClearOtherWebSessionsHelp': `You can log in on websites that support signing in with ${appName}.`,
  'TerminateWebSessionInfo': `Click to disconnect from your ${appName} account.`,
  'EnablePhotoSpoiler': 'Hide with spoiler',
  'DisablePhotoSpoiler': 'Remove spoiler',
  'LimitReachedFolders': `You have reached the limit of **%1$d** folders. You can double the limit to **%2$d** folders by subscribing to **${appName} Premium**.`,
  ...
  'LimitReachedSharedFolderInvites': `You have reached the limit of **%1$d** links. You can double the limit to **%2$d** links by subscribing to **${appName} Premium**.`,
  ...
  'GiftTelegramPremiumTitle': `Gift ${appName} Premium`,
  'GiftTelegramPremiumDescription': `Give **%1$s** access to exclusive features with **${appName} Premium**.`,
  ...
  'ChannelAntiSpamInfo': `${appName} will filter more spam, but may occasionally affect ordinary messages. You can report False Positives in Recent Actions.`,
  'ChannelLinkInfo': `Anyone who has ${appName} installed will be able to join your channel by following this link.`,
  ...
  'BotWebAppDisclaimerSubtitle': `You are about to use a mini app operated by an independent party **not affiliated with ${appName}**. You must agree to the Terms of Use for mini apps to continue.`,
  'TermsOfUse': 'Terms of Use',
  'WebAppDisclaimerUrl': `https://${shortDomain}/tos/mini-apps`,
  ...
  'PremiumNeededForBoosting': `Only **${appName} Premium** subscribers can boost channels. Do you want to subscribe to **${appName} Premium**?`,
  ...
  'CantBoostWithGiftedPremiumDescription': `Because your **${appName} Premium** subscription was gifted to you, you can\'t use it to boost channels.`,
  'MoreBoosts': {
  ...
  'BoostingGiveawayJustStarted': `%s just started a giveaway of ${appName} Premium subscriptions to its followers.`,
  'BoostingWinnersDate': '**Winners Selection Date**',
  'BoostingGiveawayPrizes': '**Giveaway Prizes**',
  'BoostingGiveawayMsgInfoPlural1': {
    'other_value': `**%1$d** ${appName} Premium`
  },
  ...
  'BoostingGiveawayHowItWorksText': {
    'one_value': `This giveaway is sponsored by the admins of **%2$s**, who acquired **%3$s ${appName} Premium** subscription for %4$s for its followers.`,
    'other_value': `This giveaway is sponsored by the admins of **%2$s**, who acquired **%3$s ${appName} Premium** subscriptions for %4$s for its followers.`
  },
  ...
  'BoostingGiveawayHowItWorksTextEnd': {
    'one_value': `This giveaway was sponsored by the admins of **%2$s**, who acquired **%3$s ${appName} Premium** subscription for %4$s for its followers.`,
    'other_value': `This giveaway was sponsored by the admins of **%2$s**, who acquired **%3$s ${appName} Premium** subscriptions for %4$s for its followers.`
  },
  ...
  'BoostingReceivedPrizeDuration': `Your prize is a **${appName} Premium** subscription for %s.`,
  'BoostingUnclaimedPrize': 'Unclaimed Prize',
  'BoostingYouHaveUnclaimedPrize': 'You have an unclaimed prize from a giveaway by **%s**.',
  'BoostingUnclaimedPrizeDuration': `This prize is a **${appName} Premium** subscription for %s.`,
  ...
  'BoostingReceivedGiftDuration': `Your gift is a **${appName} Premium**\nsubscription for %s.`,
  'BoostingUsedGiftLink': 'Used Gift Link',
  'BoostingGiftLink': 'Gift Link',
  'BoostingLinkUsed': `This link was used to activate\na **${appName} Premium** subscription.`,
  'BoostingLinkAllows': `This link allows you to activate\na **${appName} Premium** subscription.`,
  'BoostingLinkAllowsToUser': `This link allows **%1$s** to activate a **${appName} Premium** subscription.`,
  ...
  'BoostingDate': 'Date',
  'BoostingTelegramPremiumFor': `${appName} Premium for %s`,
  ...
  'BoostingPremium': `${appName} Premium`,
  'BoostingStars': `${appName} Stars`,
  ...
  'LimitReachedChatInFolders': `Sorry, you can\'t add more than **%1$d** chats to a folder. You can increase this limit to **%2$d** by subscribing to **${appName} Premium**.`,
  ...
  'TelegramPremiumUserGiftedPremiumDialogTitleWithPlural': `**%1$s** has gifted you a %2$s subscription to ${appName} Premium.`,
  'TelegramPremiumUserGiftedPremiumDialogTitleWithPluralSomeone': `Someone has gifted you a %1$s subscription to ${appName} Premium.`,
  ...
  'GiftPremiumActivateErrorTitle': `You already have ${appName} Premium`,
  ...
  'PrivacyLastSeenPremium': `Subscribe to ${appName} Premium`,
  ...
  'PrivacyLastSeenPremiumForPremium': `Subscribed to ${appName} Premium`,
  'PrivacyLastSeenPremiumInfoForPremium': `Because you are a ${appName} Premium subscriber, you will see the last seen and read time of all users who are sharing it with you – even if you are hiding yours.`,
  ...
  'PremiumReadButton2': `Subscribe to ${appName} Premium`,
  ...
  'PremiumLastSeenButton2': `Subscribe to ${appName} Premium`,
  ...
  'ReportAd': 'Report Ad',
  'ReportAdLearnMore': `Learn more about our [Ad Policies and Guidelines](https://ads.${shortDomain}/guidelines).`,
  'AdHidden': `You will no longer see ads from ${appName}.`,
  'SponsoredMessageAdWhatIsThis': 'what\'s this?',
  'RevenueSharingAdsAlertSubtitle': `${appName} Ads are very different from ads on other platforms. Ads such as this one:`,
  'RevenueSharingAdsInfo1Title': 'Respect Your Privacy',
  'RevenueSharingAdsInfo1Subtitle': `Ads on ${appName} do not use your personal information and are based on the channel in which you see them.`,
  'RevenueSharingAdsInfo2Title': 'Help the Channel Creator',
  'RevenueSharingAdsInfo2Subtitle': `50% of the revenue from ${appName} Ads goes to the owner of the channel where they are displayed.`,
  'RevenueSharingAdsInfo3Title': 'Can Be Removed',
  'RevenueSharingAdsInfo3Subtitle': `You can turn off ads by subscribing to **${appName} Premium**, and Level %1$s channels can remove them for their subscribers.`,
  'RevenueSharingAdsInfo4Title': 'Can I Launch an Ad?',
  'RevenueSharingAdsInfo4Subtitle2': `Anyone can create an ad to display in this channel — with minimal budgets. Check out the **${appName} Ad Platform** for details. %1$s`,
  ...
  'FactCheckToast': `This clarification was provided by ${appName}.`,
  'FactCheckFooter': `This clarification was provided by ${appName}.`,
  ...
  'AnimatedEffectPremium': `Subscribe to **${appName} Premium** to add this animated effect.`,
  ...
  'ActionGiftStarsSubtitle': `With Stars, **%s** is able to unlock content and services on ${appName}.`,
  'ActionGiftStarsSubtitleYou': `Use Stars to unlock content and services on ${appName}.`,
  ...
  'StarGiftUpgradeTransferableText': `Send your upgraded gift to any of your friends on ${appName}.`,
  'StarGiftUpgradeTransferableTextPrepaid': `%s will be able to send the gift to anyone on ${appName}.`,
  ...
  'StarGiftValueAboutAverage': `The average sale price of **%s** gifts on ${appName} and Fragment over the past month.`,
  'StarGiftValueAboutLastFragment': 'This is the price at which **%s** was last sold on Fragment',
  'StarGiftValueAboutLastTelegram': `This is the price at which **%s** was last sold on ${appName}`,
  ...
  'StarGiftMinimumPriceTooltip': `**%s** is the floor price for **%s** gifts listed on ${appName} and Fragment.`,
  'StarGiftAveragePrice': 'Average Price',
  'StarGiftAveragePriceTooltip': `**%s** is the average sale price of **%s** gifts on ${appName} and Fragment over the past month.`,
  'StarGiftViewResaleTelegram': `%s for sale on ${appName} %s`,
  ...
  'Reported2': `${appName} moderators will review your report. Thank you!`,
  ...
  'Contacts.PhoneNumber.NotRegistred': `The person with this phone number is not registered on ${appName} yet.`,
  'Channel.UsernameAboutChannel': `People can share this link with others and can find your channel using ${appName} search.`,
  'Channel.UsernameAboutGroup': `People can share this link with others and find your group using ${appName} search.`,
  ...
  'Chat.Service.PeerJoinedTelegram': `%@ joined ${appName}`,
  ...
  'Chat.Message.Ad.Text': `Unlike other apps, ${appName} never uses your private data to target ads. Sponsored messages on ${appName} are based solely on the topic of the public channels in which they are shown. This means that no user data is mined or analyzed to display ads, and every user viewing a channel on ${appName} sees the same sponsored messages.\n\nUnlike other apps, ${appName} doesn\'t track whether you tapped on a sponsored message and doesn\'t profile you based on your activity. We also prevent external links in sponsored messages to ensure that third parties can’t spy on our users. We believe that everyone has the right to privacy, and technological platforms should respect that.\n\n${appName} offers a free and unlimited service to hundreds of millions of users, which involves significant server and traffic costs. In order to remain independent and stay true to its values, ${appName} developed a paid tool to promote messages with user privacy in mind. We welcome responsible advertisers at:\n\n%@\n\nSponsored Messages are currently in test mode. Once they are fully launched and allow ${appName} to cover its basic costs, we will start sharing ad revenue with the owners of public channels in which sponsored messages are displayed.\n\nOnline ads should no longer be synonymous with abuse of user privacy. Let us redefine how a tech company should operate – together.`,
  ...
  'Chat.Message.Sponsored.Link': `https://ads.${shortDomain}`,
  ...
  'CustomEmoji.PremiumAlert': `Subscribe to ${appName} Premium to unlock this emoji. [Read More]()`,
  'Date.Today': 'Today',
  ...
  'PrivacySettings.Voice.PremiumError': `Only subscribers of [${appName} Premium]() can restrict receiving Voice and Video Messages.`,
  ...
  'PrivacySettingsController.P2p.Desc': `Disabling peer-to-peer will relay all calls through ${appName} servers to avoid revealing your IP address, but may slightly decrease audio and video quality.`,
  ...
  'Action.SuggestedProfilePhoto': `un1 suggests this photo for your ${appName} profile`,
  ...
  'Schedule.Repeat.PremiumRequired': `Subscribe to **[${appName} Premium]()** to schedule repeating messages.`,
  ...
  'TwoStepAuth.GenericHelp': `You have enabled Two-Step verification.\nYou\'ll need the password you set up here to log in to your ${appName} account.`,
  ...
  'Premium.Boarding.NoAds.Info': `No more ads in public channels where ${appName} sometimes shows ads.`,
  ...
  'Premium.Boarding.Badge.Info': `An exclusive badge next to your name showing that you subscribe to ${appName} Premium.`,
  ...
  'Premium.Boarding.Title': `${appName} Premium`,
  'Premium.Boarding.Info': `Go **beyond the limits** and **unlock dozens of exclusive** features by subscribing to **${appName} Premium**.`,
  'Premium.Boarding.Got.Title': 'You are all set!',
  'Premium.Boarding.Got.Info': `Thank you for subscribing to ${appName} Premium. Here\'s what is now unlocked.`,
  'Premium.Boarding.Peer.Title': `[%@](profile) is a subscriber of\n${appName} Premium`,
  'Premium.Boarding.Peer.Info': `Owners of ${appName} Premium accounts have exclusive access to multiple additional features.`,
  ...
  'Premium.Boarding.About.Title': `About ${appName} Premium`,
  'Premium.Boarding.About.Text': `While the free version of ${appName} already gives its users more than any other messaging application, **${appName} Premium** pushes its capabilities even further.\n\n**${appName} Premium** is a paid option, because most Premium Features require additional expenses from ${appName} to third parties such as data center providers and server manufacturers. Contributions from **${appName} Premium** users allow us to cover such costs and also help ${appName} stay free for everyone.`,
  'Premium.Boarding.About.Tos': `By purchasing a Premium subscription, you agree to the ${appName} [Terms of Service](terms) and [Privacy Policy](privacy).`,
  'Premium.Boarding.AppStore.Cancelled': 'Purchase was canceled or failed.',
  'Premium.Boarding.AppStore.Success': `You successfully subscribed for ${appName} Premium.`,
  ...
  'Premium.Offset.AlreadyHave': `You already have ${appName} Premium.`,
  ...
  'Language.TranslateMessages.Channel.Premium': `Subscribe to [${appName} Premium](premium) to translate entire chats.`,
  ...
  'Chat.DownloadLimit.Text': {
    'one_value': `Subscribe to [${appName} Premium]() to increase download speeds %d time.`,
    'other_value': `Subscribe to [${appName} Premium]() to increase download speeds %d times.`
  },
  'Chat.UploadLimit.Text': {
    'one_value': `Subscribe to [${appName} Premium]() to increase upload speeds %d time.`,
    'other_value': `Subscribe to [${appName} Premium]() to increase upload speeds %d times.`
  },
  'Chat.Service.Refund': '%@ refunded %@',
  'EnableDarkMode': 'Enable Dark Mode',
  'DisableDarkMode': 'Disable Dark Mode',
  'DisableAnimations': 'Disable Animations',
  'AudioAndVideoTranscription.PremiumAlert': `Subscribe to ${appName} Premium to unlock video and audio transcription. [Read More]()`,
  ...
  'PasscodeLock.Description': `When a passcode is set, a lock icon appears above your chat list. Tap it to lock your ${appName}.`,
  ...
  'PasscodeLock.TapToLock': `Tap to lock ${appName}.`,
  ...
  'PeerInfo.AppFooter': `By launching this mini app, you agree to the [Terms of Service for Mini Apps](https://${shortDomain}/privacy).`,
  'PeerInfo.AppFooterAdmin': `By publishing this mini app, you agree to the [${appName} Terms of Service for Developers](https://${shortDomain}/privacy).`,
  ...
  'BotStorySharingNotSupported': `Sharing to Stories is not supported in the Web app. Please use one of ${appName}\'s mobile apps.`,
  ...
  'VerificationCodesBotDescription': `Third-party services, like websites and stores, can send verification codes to your phone number via ${appName} instead of SMS. Such codes will appear in this chat.\n\nIf you didn\'t request any codes – don\'t worry! Most likely, someone made a mistake when entering their number.`,
  ...
  'StarsRating.Subtitle': `This rating reflects **%s**’s activity on ${appName}. What affects it:`,
  'StarsRating.SubtitleMy': `This rating reflects your activity on ${appName}. What affects it:`,
  'StarsRating.Row1Title': `Gifts from ${appName}`,
  'StarsRating.Row1Subtitle': `100% of the Stars spent on gifts purchased from ${appName}.`,
  ...
  'EmailSetup.ChangeSubtitle': `You will receive ${appName} login codes via email and not SMS. Please enter an email address to which you have access.`,
  ...
  'AiEditor.PremiumFlood': `You have hit the limit for now. Subscribe to [${appName} Premium]() to increase the limit by 50 times or try again later.`,
