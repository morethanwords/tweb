      ...
      <div class={styles.InnerContainer}>
        ...
        <div class={styles.Frames}>
          <div class={styles.Cropper}>
            ...
            <div class={styles.CropperHorizontalBorder} />

            <div class={`${styles.CropperHandle} ${styles.CropperHandleLeft}`} />
            <div class={`${styles.CropperHandle} ${styles.CropperHandleRight}`} />
...
const ThumbnailMark = () => {
  return (
    <svg class={styles.ThumbnailMark} width="20" height="25" viewBox="0 0 20 25" fill="none" xmlns="http://www.w3.org/2000/svg">
