...
import GroupCallMicrophoneIcon from '../groupCall/microphoneIcon';
import GroupCallParticipantsElement from '../groupCall/participants';
import GroupCallParticipantsVideoElement from '../groupCall/participantVideos';
...
export default class RTMPStreamPlayback extends PopupElement {
