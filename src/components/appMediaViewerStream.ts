...
class AppMediaViewerStreamBase<
  ...
  protected buttons: {[k in 'forward' | 'close' | 'mobile-close' | ButtonsAdditionType]: HTMLElement} = {} as any;
  ...
  protected onZoom = ({initialCenterX, initialCenterY, zoom, zoomAdd, currentCenterX, currentCenterY, dragOffsetX, dragOffsetY, zoomFactor}: ZoomDetails) => {
  ...
  public close(e?: MouseEvent) {
    ...
    const promise = (new Promise<void>(resolve => resolve())).finally(() => {
