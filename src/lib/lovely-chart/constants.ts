import {LovelyChartRange} from './types';

export const DPR = window.devicePixelRatio || 1;

export const DEFAULT_RANGE: LovelyChartRange = {begin: 0.8, end: 1};
...
export const BALLOON_MARGIN = 8;

export const FONT = 'Helvetica, Arial, sans-serif';

export const AXES_FONT = `300 10px ${FONT}`;
...
export const MINIMAP_MARGIN = GUTTER;
export const MINIMAP_LINE_WIDTH = 1;
export const MINIMAP_EAR_WIDTH = 10;
export const MINIMAP_MAX_ANIMATED_DATASETS = 4;

export const ZOOM_TIMEOUT = 0;
...
export const WEEK_DAYS_SHORT = WEEK_DAYS.map((day) => day.slice(0, 3));
